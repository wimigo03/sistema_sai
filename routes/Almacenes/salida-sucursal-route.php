...
Route::prefix('salida-sucursal')->name('salida.sucursal.')->middleware(['auth'])->group(function () {
    ...
    Route::get('eliminar_registro/{salida_almacen_detalle_id}/{inventario_almacen_id}/{cantidad}', 'Almacenes\SalidaSucursalController@eliminarRegistro')->name('eliminar')->middleware('can:salida.sucursal.editar');
    Route::post('insertar-productos', 'Almacenes\SalidaSucursalController@insertarProducto')->name('insertar.producto')->middleware('can:salida.sucursal.editar');
    Route::post('update-registro-cantidad', 'Almacenes\SalidaSucursalController@updateRegistroCantidad')->name('update.registro.cantidad')->middleware('can:salida.sucursal.editar');
    Route::post('update-registro-precio-unitario', 'Almacenes\SalidaSucursalController@updateRegistroPrecioUnitario')->name('update.registro.precio.unitario')->middleware('can:salida.sucursal.editar');

    Route::post('update', 'Almacenes\SalidaSucursalController@update')->name('update')->middleware('can:salida.sucursal.editar');
    Route::get('/get_cargar_materiales', 'Almacenes\SalidaSucursalController@getCargarMateriales')->name('get.cargar.materiales')->middleware('can:salida.sucursal.editar');
    Route::post('procesar-cargar-datos', 'Almacenes\SalidaSucursalController@procesarCargarDatos')->name('cargar.datos')->middleware('can:salida.sucursal.editar');
});
