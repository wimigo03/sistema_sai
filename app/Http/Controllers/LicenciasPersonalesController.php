...
class LicenciasPersonalesController extends Controller
{
    ...
    public function detalle($id, $licencia_id)
    {
        ...
        return Datatables::of($licencia)
            ...
            ->addColumn('opciones', function ($licencia) {
                return '<a class="tts:left tts-slideIn tts-custom" aria-label="Modificar Registro" href="#" data-toggle="modal" data-target="#miModal" data-id="' . $licencia->id . '">
