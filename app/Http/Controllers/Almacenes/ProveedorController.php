...
class ProveedorController extends Controller
{
    public function index()
    {
        ...
        return view('almacenes.proveedor.index',compact('proveedores','estados'));
    }
    ...
    {
        return view('almacenes.proveedor.create');
    }
    ...
    {
        $proveedor = Proveedor::find($proveedor_id);
        return view('almacenes.proveedor.editar',compact('proveedor'));
    }
