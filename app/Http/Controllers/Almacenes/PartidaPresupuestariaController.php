...
class PartidaPresupuestariaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('almacenes.partidas_prespuestarias.index',compact('partidas_presupuestarias','tree','search_nodeId'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('almacenes.partidas_prespuestarias.create',compact('partida_presupuestaria'));
    }
    ...
    public function editar(Request $request)
    {
        ...
        return view('almacenes.partidas_prespuestarias.editar',compact('partida_presupuestaria','parent_presupuestaria','partidas_presupuestarias','hijos'));
    }
