...
<div class="row font-verdana-12">
    ...
    <div class="col-md-4 text-right">
            ...
            <a href="{{ route('expochaco.reporte') }}" class="tts:left tts-slideIn tts-custom" aria-label="CREAR NUEVO">
                <button class="btn btn-sm btn-secondary font-verdana" type="button" >Reporte de Credenciales
                </button>

                <button class="btn btn-sm btn-info font-verdana" type="button" target="_blank">Volver a Pendientes
