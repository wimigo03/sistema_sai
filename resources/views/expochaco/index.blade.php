...
<div class="row font-verdana-bg">
    ...
    <div class="col-md-4 text-right">
        @can('unidadconsumo_create')
            ...
            <a href="{{ route('expochaco.create') }}" class="tts:left tts-slideIn tts-custom" aria-label="CREAR NUEVO">
                <button class="btn btn-sm btn-success font-verdana" type="button" >crear nuevo
...
$(function() {
    ...
    var table = $('.yajra-datatable').DataTable({
        ...
        columns: [
            ...
            {data: 'telefonosol',name: 's.telefonosol',class:'text-justify p-1 font-verdana'},
