                                    ...
                                    <div class="d-flex justify-content-center">
                                        @can('canasta.beneficiarios.editar')
                                            <span class="tts:left tts-slideIn tts-custom" aria-label="Modificar">
                                                <a href="{{ route('beneficiariosdisc.editar', $datos->id) }}" class="badge-with-padding badge badge-warning">
                                        ...
                                        @can('canasta.beneficiarios.show')
                                            <span class="tts:left tts-slideIn tts-custom" aria-label="Ir a kardex">
                                                <a href="{{ route('beneficiariosdisc.show', $datos->id) }}" class="badge-with-padding badge badge-primary" target="_blank">
