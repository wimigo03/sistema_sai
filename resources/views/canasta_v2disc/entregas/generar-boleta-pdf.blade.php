            ...
            <table class="font-verdana-10" cellspacing="0" cellpadding="0" style="width: 100%; padding: 0px; margin: 0;">
                <tr>
                    ...
                    <td rowspan="3" width="25%" class="align-center align-middle linea-derecha linea-inferior" style="padding: 2px;">
                        ...
                        @endphp
                        <img src="{{ $imageData }}" class="foto-boleta-pdf" alt="#"  style="width:120px;height:120px;"/>
                    </td>
                ...
                <tr>
                    ...
                    <td class="align-center linea-izquierda linea-derecha linea-inferior">
                        &nbsp;
                </tr>
                ...
                <tr>
                    <td rowspan="2" class="linea-derecha align-superior font-verdana-10">
                        ...
                        <b>Discapacidad: </b>{{ $entrega->Discgrado }}
                        <br>
                ...
                <tr>
                    <td class="align-center align-inferior linea-derecha linea-inferior font-verdana-9">
                        {{ $entrega->beneficiario->tutor}}<br>{{ $entrega->beneficiario->parentesco}}
                    </td>
                </tr>
                <tr>
                    <td class="align-center linea-derecha">
