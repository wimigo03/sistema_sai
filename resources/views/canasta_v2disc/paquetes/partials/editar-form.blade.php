<form action="{{ route('paquetes.update') }}"  method="post" id="form">
    @csrf
    ...
    <div class="form-group row font-roboto-12">
        <div class="col-md-2 pr-1 pl-1">
            ...
            <select name="gestion" id="gestion" placeholder="--Seleccionar--" class="form-control select2 font-roboto-12" required>
    ...
    <div class="form-group row font-roboto-12">
        <div class="col-md-12 pr-1 pl-1">
            ...
            <textarea type="text" class="form-control font-roboto-12" id="items" name="items" required>{{ $paquetes->items }}</textarea>
        </div>
    </div>
