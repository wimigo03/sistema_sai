                    ...
                    <tbody>
                        @foreach ($entregas as $datos)
                            <tr class="font-verdana-8 linea-inferior-gris linea-izquierda-gris linea-derecha-gris">
                                ...
                                <td class="linea-derecha-gris" align="center" style="vertical-align: middle;">{{ $datos->_distrito }}</td>
                                <td class="linea-derecha-gris" align="center" style="vertical-align: middle;">{{ $datos->_barrio }}</td>
