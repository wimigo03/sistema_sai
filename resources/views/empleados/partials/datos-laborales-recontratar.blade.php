...
<div class="form-group row font-roboto-12">
    ...
    <div class="col-md-2 pr-1 pl-1">
        ...
        <input type="text" name="seguro_salud" value="{{ old('seguro_salud') }}" id="seguro_salud" class="form-control font-roboto-12">
    </div>
    <div class="col-md-2 pr-1 pl-1">
...
<div class="form-group row font-roboto-12">
    ...
    <div class="col-md-2 pl-1">
        <label for="exp_progvacacion" class="d-inline">
            <input type="checkbox" name="progvacacion" id="progvacacion"  {{ old('progvacacion') == 'on' ? 'checked' : '' }} onclick="check_programacion_vacacion()">
            <b>Vacacion</b>
        </label>
