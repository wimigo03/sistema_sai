<form {{--method="post"--}} action="{{-- route('archivos2.insertar') --}}" enctype="multipart/form-data" id="form">
    ...
    <div class="form-group row font-roboto-12 align-items-center">
        ...
        <div class="col-md-2 pr-1 pl-1">
            <input type="text" name="fecha" value="{{ old('fecha')}}" placeholder="dd/mm/aaaa" class="form-control font-roboto-12" id="fecha" data-language="es">
        </div>
    </div>
    <div class="form-group row font-roboto-12 align-items-center">
        <div class="col-md-5 pr-1 pl-1 text-right">
        ...
        <div class="col-md-2 pr-1 pl-1">
            <input type="text" id="nombredocumento" value="{{ old('nombredocumento') }}" name="nombredocumento" class="form-control font-roboto-12" required>
        </div>
    </div>
    <div class="form-group row font-roboto-12 align-items-center">
        <div class="col-md-5 pr-1 pl-1 text-right">
        ...
        <div class="col-md-5 pr-1 pl-1">
            <textarea type="text" name="referencia" value="{{ old('referencia') }}" class="form-control font-roboto-12" id="referencia" onchange="javascript:this.value=this.value.toUpperCase();" required></textarea>
        </div>
    </div>
    <div class="form-group row font-roboto-12 align-items-center">
        <div class="col-md-5 pr-1 pl-1 text-right">
