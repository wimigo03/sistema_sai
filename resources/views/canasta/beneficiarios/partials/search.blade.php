<form action="#" method="get" id="form">
    <div class="form-group row">
        ...
        <div class="col-md-2 pr-1 pl-1">
            <input type="text" name="ap" placeholder="--Ap. Paterno--" value="{{request('ap')}}" class="form-control form-control-sm font-verdana-bg">
        </div>
        <div class="col-md-2 pr-1 pl-1">
            <input type="text" name="am" placeholder="--Ap. Materno--" value="{{request('am')}}" class="form-control form-control-sm font-verdana-bg">
        </div>
        <div class="col-md-2 pr-1 pl-1">
    ...
    <div class="form-group row">
        <div class="col-md-2 pr-1">
            <input type="text" class="form-control form-control-sm font-verdana-bg" name="natalicio" id="natalicio" placeholder="--Natalicio--" data-language="es" value="{{ request('natalicio') }}" autocomplete="off">
        </div>
        <div class="col-md-2 pr-1 pl-1">
