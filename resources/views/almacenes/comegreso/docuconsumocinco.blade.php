...
<div class="row font-verdana-bg">
    ...
    <div class="col-md-10 text-right titulo">
        <b>DETALLE DE COMPROBANTE ingreso estado cinco</b>
    </div>
    <div class="col-md-12"  >
        <hr class="hrr">
    </div>
...
<div class="body-border" style="background-color: #FFFFFF;">
    <form action="{{ route('comegreso.insertarcinco') }}" method="post" id="form">
        @csrf
     
  
        <input type="hidden" class="form-control" name="idcomegreso" placeholder="" value="{{$idcomegreso}}">
                        ...
                        <tr>
                           ...
                           <td class="text-center p-1">
                               <span class="tts:left tts-slideIn tts-custom" aria-label="Editar">
                                    <a href="{{route('comegreso.editararchivo',$prod->iddetallecomegreso)}}" >
