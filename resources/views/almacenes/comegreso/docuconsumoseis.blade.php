...
<div class="row font-verdana-bg">
    ...
    <div class="col-md-10 text-right titulo">
        <b>DETALLE DE COMPROBANTE INGRESO estado seis</b>
    </div>
    <div class="col-md-12"  >
        <hr class="hrr">
    </div>
    ...
    <div class="col-md-9 text-right">
        ...
        <a href="{{route('comegreso.aprovarseis',$comegresos->idcomegreso)}}" 
          onclick="return confirm('Se va a validar..esta seguro ?..')">
          <button class="btn btn-sm  btn-info   font-verdana" type="button" >
              &nbsp;<i class="fa fa-lg fa-thumbs-up" aria-hidden="true"></i>&nbsp;Validar Comprobante
          </button>
      </a>
      &nbsp; &nbsp; &nbsp;
      <span class="tts:left tts-slideIn tts-custom" aria-label="Imprimir Solicitud">
        <a href="{{route('comegreso.solicitudseis',$comegresos->idcomegreso)}}">
                        ...
                        <tr>
                           ...
                           <td class="text-center p-1">
                               <span class="tts:left tts-slideIn tts-custom" aria-label="Editar">
                                    <a href="{{route('comegreso.editararchivoseis',$prod->iddetallecomegreso)}}" >
                                        <span class="text-primary">
