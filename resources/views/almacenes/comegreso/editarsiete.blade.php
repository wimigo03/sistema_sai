...
@section('content')
    ...
    <div class="row font-verdana-bg">
        ...
        <div class="col-md-8 text-right titulo">
            <b>FORMULARIO DE EGRESO estado 7</b>
        </div>
        <div class="col-md-12">
            <hr class="hrr">
        </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <label for="idempleado" class="d-inline font-verdana-bg">
                        <b>Recibido Por</b>&nbsp;<span style="font-size:10px; color: red;">validado</span>
                    </label>
                    <select name="idempleado" id="idempleado" placeholder="--Seleccionar--"
                        ...
                        @foreach ($empleados as $area)
                            ...
                            @else
                            <option disabled value="{{$area->idemp}}">COD:&nbsp;&nbsp;{{$area->idemp }}&nbsp;&nbsp;NOMB:&nbsp;&nbsp;{{$area->nombres }}&nbsp;{{$area->ap_pat }}&nbsp;{{$area->ap_mat }}&nbsp;Cargo: {{$area->nombrecargo }}&nbsp;Area: {{$area->nombrearea }}</option>
                            @endif
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-5">
                    <label for="detalle" class="d-inline font-verdana-bg">
                        <b>Glosa</b>&nbsp;<span style="font-size:10px; color: red;">validado</span>
                    </label>
                    <textarea disabled name="detalle" cols="1" rows="3" class="form-control form-control-sm font-verdana-bg" id="detalle" onkeyup="convertirAMayusculas(this)">{{$comegresos->detallecomegreso}}</textarea>
                </div>
                <div class="col-md-5">
                    ...
                    @else
                        <option disabled value="{{ $area->idproveedor }}"> CODIGO: {{ $area->idproveedor }} //NOMBRE: {{ $area->nombreproveedor }} //REPRESENTANTE: {{ $area->representanteproveedor }} //DIRECCION:  {{ $area->direccionproveedor }}</option>
                    @endif
                @endforeach
                    </select>
                </div>
