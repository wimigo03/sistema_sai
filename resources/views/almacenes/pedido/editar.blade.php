    ...
    <form method="post" action="{{ route('apedido.update') }}" id="form">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-2">
                ...
                <input   type="text" name="fechasolicitud" id="fechasolicitud" placeholder="dd/mm/aaaa" data-language="es"
            ...
            <div class="col-md-6" >
                ...
                class="form-control form-control-sm select2">
                    ...
                    @else
                    <option value="{{$area->idcomingreso}}">CODIGO:&nbsp;&nbsp;{{$area->codcatprogramatica }}&nbsp;&nbsp;//NOMBRE:&nbsp;&nbsp;{{$area->nombrecatprogramatica }}</option>
                    @endif
            ...
            {{-- <div class="col-md-6" >
                <label for="proyecto" class="d-inline font-verdana-bg">
                    <b>PROYECTO</b>&nbsp;<span style="font-size:10px; color: red;">*</span>
                </label>
                <select  name="proyecto" id="proyecto" placeholder="--Seleccionar--" 
                class="form-control form-control-sm select2">
                    <option value="">-</option>
                    @foreach ($comingresos as $area)

                    @if ($area->idcomingreso ==$vales->idcomingreso)
                    <option value="{{$area->idcomingreso }}" selected>{{$area->idcatprogramaticacomb }}</option>
                    @else
                    <option value="{{$area->idcomingreso}}">{{$area->idcatprogramaticacomb }}</option>
                    @endif
