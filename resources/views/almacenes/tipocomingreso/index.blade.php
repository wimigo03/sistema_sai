...
<div class="row font-verdana-bg">
    <div class="col-md-8 titulo">
        <b>TIPO DE BALANCE--</b><b style='color:red'>{{$idd->nombrearea}} </b>--
    </div>
    <div class="col-md-4 text-right">

       
            <a href="{{route('tipocomingreso.create')}}" class="tts:left tts-slideIn tts-custom" aria-label="Agregar">
...
$(function() {
    ...
    var table = $('.yajra-datatable').DataTable({
        ...
        serverSide: true,
        autoWidth: false,
        ajax: "{{ route('tipocomingreso.list') }}",
        columns: [
            {data: 'DT_RowIndex',orderable: false,searchable: false,class:'text-justify p-1 font-verdana'},
            {
                data: 'codigocomin',name: 'codigocomin',class:'text-justify p-1 font-verdana'},
            {
                data: 'nombrecoming',name: 'nombrecoming',class:'text-justify p-1 font-verdana'},
