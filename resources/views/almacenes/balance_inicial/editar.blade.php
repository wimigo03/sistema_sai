...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item font-roboto-14"><a href="{{ route('ingreso.sucursal.index') }}"> Balances Iniciales</a></li>
    ...
    <div class="card">
        <div class="card-header">
            <div class="row d-flex align-items-center">
                <i class="fa-solid fa-file-lines fa-fw"></i>&nbsp;<b class="title-size">MODIFICAR REGISTRO BALANCE INICIAL</b>
            </div>
        </div>
            ...
            async function cargarProductos(){
                ...
                var fila = "<tr class='font-roboto-13'>"+
                                ...
                                "<td class='text-right p-2 text-nowrap' width='100px'>"+
                                    ...
                                    "<input type='text' placeholder='0' data-id='" + ingreso_almacen_detalle_id + "' class='form-control font-roboto-13 text-right input-cantidad' oninput='cantidadPrecio(this);'>" +
                                "</td>" +
                                "<td class='text-right p-2 text-nowrap' width='100px'>"+
                                    ...
                                    "<input type='text' placeholder='0' data-id='" + ingreso_almacen_detalle_id + "' class='form-control font-roboto-13 text-right input-precio-unitario' oninput='cantidadPrecio(this);'>" +
                                "</td>" +
                                "<td class='text-right p-2 text-nowrap' width='100px'>"+
