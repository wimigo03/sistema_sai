...
<div class="row font-verdana-bg">
    ...
    <div class="col-md-8 text-right titulo">
        <b>FORMULARIO DE BALANCE</b> <b style='color:red'>APROBADO</b>
    </div>
    <div class="col-md-12">
        <hr class="hrr">
    </div>
...
<div class="body-border" style="background-color: #FFFFFF;">
    <form method="post" action="{{ route('comingreso.update') }}" id="form">
        @csrf
        {{--@method('PUT')--}}
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4">
                <label for="detalle" class="d-inline font-verdana-bg">
                    <b>detalle</b>&nbsp;<span style="font-size:10px; color: red;">validado</span>
                </label>
            ...
            <div class="col-md-2">
                <label for="numpreventivo" class="d-inline font-verdana-bg">
                    <b>N° preventivo</b>&nbsp;<span style="font-size:10px; color: red;">validado</span>
                </label>
                ...
                <label for="factura" class="d-inline font-verdana-bg">
                    <b>N° factura</b>&nbsp;<span style="font-size:10px; color: red;">validado</span>
                </label>
            ...
            <div class="col-md-5">
                ...
                class="form-control form-control-sm select2">
                    ...
                    @foreach ($programas as $local)
                                ...
                                <option value="{{$local->idprogramacomb}}" selected>{{$local->nombreprograma}} //DIRECCION: {{$local->direccion}}
                                </option>
                                @else
                                <option value="{{$local->idprogramacomb}}">{{$local->nombreprograma}} //DIRECCION: {{$local->direccion}}</option>
                                @endif
            ...
            <div class="col-md-6">
                ...
                class="form-control form-control-sm select2">
                    ...
                    @foreach ($catprogramaticas as $local)
                                ...
                                <option value="{{$local->idcatprogramaticacomb}}" selected> CODIGO: {{$local->codcatprogramatica}} //NOMBRE: {{$local->nombrecatprogramatica }}
                                </option>
                                @else
                                <option value="{{$local->idcatprogramaticacomb}}"> CODIGO: {{$local->codcatprogramatica}} //NOMBRE: {{$local->nombrecatprogramatica }}</option>
                                @endif
            ...
            <div class="col-md-6">
                ...
                <select  name="proveedor" id="proveedor" placeholder="--Seleccionar--" 
                class="form-control form-control-sm select2">
                    <option value="">-</option>
                    @foreach ($proveedores as $local)

                                @if ($local->idproveedor==$comingresos->idproveedor)
                                <option value="{{$local->idproveedor}}" selected>CODIGO: {{$local->idproveedor}} //NOMBRE: {{$local->nombreproveedor}} //DUEÑO: {{$local->representanteproveedor}} //DIRECCION: {{$local->direccionproveedor}} //TELEFONO: {{$local->telefonoproveedor}}
                                </option>
                                @else
...
@section('scripts')
    <script>
        ...
        function validar_formulario(){
            if($("#numcompra").val() == ""){   
                message_alert("El campo <b>[numcompra]</b> es un dato obligatorio...");
                return false;
            }
            if($("#numsolicitud").val() == ""){   
                message_alert("El campo <b>[numsolicitud]</b> es un dato obligatorio...");
                return false;
            }
            if($("#numpreventivo").val() == ""){   
                message_alert("El campo <b>[numpreventivo]</b> es un dato obligatorio...");
                return false;
            }
            if($("#factura").val() == ""){   
                message_alert("El campo <b>[factura]</b> es un dato obligatorio...");
                return false;
            }
            if($("#detalle").val() == ""){   
            ...
            if($("#proveedor >option:selected").val() == ""){   
                message_alert("El campo de seleccion <b>[proveedor]</b> es un dato obligatorio...");
                return false;
            }
            if($("#idcategoria >option:selected").val() == ""){   
                message_alert("El campo de seleccion <b>[idcategoria]</b> es un dato obligatorio...");
                return false;
            }
            if($("#idprograma >option:selected").val() == ""){   
                message_alert("El campo de seleccion <b>[idprograma]</b> es un dato obligatorio...");
                return false;
            }  
