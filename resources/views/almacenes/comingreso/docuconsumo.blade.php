...
<div class="row font-verdana-bg">
    ...
    <div class="col-md-8 text-right titulo">
        <b>DETALLE DE BALANCE INICIAL</b>
    </div>
    <div class="col-md-12"  >
        <hr class="hrr">
    </div>
...
<div class="body-border" style="background-color: #FFFFFF;">
    <form action="{{ route('comingreso.insertar') }}" method="post" id="form">
        @csrf
        <br>
        <input type="hidden" class="form-control" name="idcomingreso" placeholder="" value="{{$idcomingreso}}">
...
<div class="col-md-10 text-right">
    ...
    @if ($compras->estado1 == 1)
        <b style="color: orange">SIN REGISTRO DEL DETALLE</b>
    @elseif ($compras->estado1 == 2)
        <a href="{{ route('comingreso.almacendos', $compras->idcomingreso) }}"
            ...
            <button class="btn btn-sm btn-info   font-verdana" type="button">
                &nbsp;<i class="fa fa-lg fa-plus" aria-hidden="true"></i>&nbsp;Validar Detalle
            </button>
        </a>
                        ...
                        <tr>
                            ...
                            <td class="text-center p-1">
                                ...
                                <span class="tts:left tts-slideIn tts-custom" aria-label="Editar">
                                    <a href="{{route('comingreso.editararchivo',$prod->iddetallecomingreso)}}" 
                                      
                                        <span class="text-primary">
                                            <i class="fa-solid fa-2xl fa-edit" aria-hidden="true"></i>
                                        </span>
                                    </a>
                                </span>
