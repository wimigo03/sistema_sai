...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item font-roboto-14"><a href="{{ route('partida.presupuestaria.index') }}"><i class="fa-solid fa-list-ul fa-fw"></i> Partidas Presupuestarias</a></li>
    ...
    <div class="card">
        <div class="card-header">
            <div class="row d-flex align-items-center">
                <i class="fa-solid fa-list-ul fa-fw"></i>&nbsp;<b class="title-size">REGISTRAR PARTIDA PRESUPUESTARIA PRINCIPAL</b>
            </div>
        </div>

        <div class="card-body">
            @include('almacenes.partidas_prespuestarias.partials.form-editar')
        </div>
    </div>
@section('scripts')
