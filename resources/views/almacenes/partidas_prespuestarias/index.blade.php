...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item font-roboto-14 active">Partidas Presupuestarias</li>
@endsection
<style>
    ...
    <div class="card">
        <div class="card-header">
            <div class="row d-flex align-items-center">
                <i class="fa-solid fa-list-check fa-fw"></i>&nbsp;<b class="title-size">PARTIDAS PRESUPUESTARIAS</b>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <span class="tts:right tts-slideIn tts-custom" id="btn-create-principal" aria-label="Registrar Partida Presupuestaria Principal" style="cursor: pointer;">
                            <span class="btn btn-primary font-roboto-12" onclick="createPartidaPresupuestariaPrincipal();">
                    ...
                    <div class="col-md-5">
                        <span class="tts:left tts-slideIn tts-custom float-right" id="btn-modificar" aria-label="Modificar" style="cursor: pointer;">
                            <span class="btn btn-warning font-roboto-12" onclick="editar();">
                        ...
                        <span class="tts:left tts-slideIn tts-custom float-right mr-1" id="btn-create-dependiente" aria-label="Registrar Partida Presupuestaria Dependiente" style="cursor: pointer;">
                            <span class="btn btn-success font-roboto-12" onclick="createPartidaPresupuestariaDependiente();">
                                <i class="fa-solid fa-plus fa-fw"></i>
                            </span>
                        </span>
                    </div>
