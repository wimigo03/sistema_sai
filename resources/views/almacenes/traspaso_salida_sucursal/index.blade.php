...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            @include('almacenes.traspaso_salida_sucursal.partials.search')
            @include('almacenes.traspaso_salida_sucursal.partials.table')
        </div>
    </div>
    @section('scripts')
        <script type="text/javascript">
            ...
            function create(){
                var url = "{{ route('traspaso.salida.sucursal.create') }}";
                window.location.href = url;
            }

            function search(){
                var url = "{{ route('traspaso.salida.sucursal.search') }}";
                $("#form").attr('action', url);
                $("#form").submit();
            }

            function limpiar(){
                var url = "{{ route('traspaso.salida.sucursal.index') }}";
                window.location.href = url;
            }
        </script>
    @endsection
