    ...
    <div class="card">
        <div class="card-header">
            <div class="row d-flex align-items-center">
                <i class="fa-solid fa-bars-staggered fa-fw"></i>&nbsp;<b class="title-size">REGISTRAR</b>
            </div>
        </div>

        <div class="card-body">
            @include('almacenes.categoria_programatica.partials.form-create')
        </div>
    </div>
@section('scripts')
    <script type="text/javascript">
        ...
        function confirmar(){
            var url = "{{ route('categoria.programatica.store') }}";
