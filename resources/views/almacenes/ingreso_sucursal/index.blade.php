...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item font-roboto-14 active">Ingreso de materiales</li>
@endsection
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            @include('almacenes.ingreso_sucursal.partials.search')
            @include('almacenes.ingreso_sucursal.partials.table')
        </div>
    </div>
    @section('scripts')
        <script type="text/javascript">
            ...
            function create(){
                var url = "{{ route('ingreso.sucursal.create') }}";
                window.location.href = url;
            }

            function search(){
                var url = "{{ route('ingreso.sucursal.search') }}";
