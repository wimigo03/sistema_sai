                                    ...
                                    @foreach ($ingreso_almacen_detalles as $datos)
                                        ...
                                        <tr class="font-roboto-13">
                                            ...
                                            <td class="text-right p-2 text-nowrap" width='100px'>
                                                <input type='text' value="{{ $datos->cantidad == 0 ? '' : $datos->cantidad }}" {{--name='cantidad[]'--}} placeholder='0' data-id="{{ $datos->id }}" class='form-control font-roboto-14 text-right input-cantidad {{ $datos->cantidad == 0 || $datos->cantidad == '' ? 'is-invalid' : '' }}' oninput="cantidadPrecio(this);">
                                            </td>
                                            <td class="text-right p-2 text-nowrap" width='100px'>
                                                <input type='text' value="{{ $datos->precio_unitario == 0 ? '' : $datos->precio_unitario }}" {{--name='precio_unitario[]'--}} placeholder='0' data-id="{{ $datos->id }}" class='form-control font-roboto-14 text-right input-precio-unitario {{ $datos->precio_unitario == 0 || $datos->precio_unitario == '' ? 'is-invalid' : '' }}' oninput="cantidadPrecio(this);">
                                            </td>
                                            <td class="text-right p-2 text-nowrap" width='100px'>
