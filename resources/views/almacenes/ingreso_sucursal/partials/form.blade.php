    ...
    <div class="div_cabecera mb-4">
        <div class="row mb-2">
            ...
            <div class="col-12 col-md-6 col-lg-2 mb-2">
                ...
                <input type="text" name="fecha_ingreso" placeholder="dd-mm-yyyy" id="fecha_ingreso" value="{{ isset($ingreso_almacen) ? \Carbon\Carbon::parse($ingreso_almacen->created_at)->format('d-m-Y') : old('fecha_ingreso') }}" class="form-control font-roboto-14">
            </div>
