            ...
            <div class="div_cabecera mb-4">
                <div class="row mb-2">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-2">
                        ...
                        <div class="d-flex flex-column flex-md-row gap-3 justify-content-center justify-content-md-end">
                            @can('ingreso.sucursal.ingresar')
                                ...
                                @endif
                            @endcan
                            <button class="btn btn-danger w-100 w-md-auto btn-size  mr-2 mb-2 mb-md-0" type="button" onclick="cancelar();">
                                <i class="fas fa-times fa-fw"></i> Cancelar
                            </button>
                            @can('ingreso.sucursal.pdf')
                                <button class="btn btn-warning w-100 w-md-auto btn-size mr-2 mb-2 mb-md-0" type="button" onclick="pdf();">
                    ...
                    <div class="col-12 col-md-6 col-lg-2 mb-2">
                        <label for="" class="form-label d-inline font-roboto-14">N° Preventivo</label>
                        <input type="text" id="n_preventivo" value="{{ $ingreso_almacen->n_preventivo }}" class="form-control font-roboto-14" disabled>
                    </div>
                    <div class="col-12 col-md-6 col-lg-2 mb-2">
                        <label for="" class="form-label d-inline font-roboto-14">N° de O.C.</label>
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-2">
                        <label for="" class="form-label d-inline font-roboto-14">N° de Ingreso</label>
                    ...
                    <div class="col-12 col-md-6 col-lg-2 mb-2">
                        <label for="" class="form-label d-inline font-roboto-14">Fecha de Ingreso</label>
