<form action="#" method="post" id="form">
    ...
    <div class="row font-roboto-12">
        ...
        <div class="col-md-2 pr-1 pl-1 mb-2">
            ...
            <input type="text" name="cod_solicitud" value="{{ $codigo_solicitud }}" id="cod_solicitud" class="form-control font-roboto-12" disabled>
        </div>
        <div class="col-md-12 pr-1 pl-1 mb-2">
            <label for="detalle" class="d-inline"><b>Observaciones</b></label>
            <textarea name="obs" class="form-control font-roboto-12" id="obs" oninput="this.value = this.value.toUpperCase();">{{ old('obs') }}</textarea>
        </div>
    </div>
                ...
                <div class="form-group row font-roboto-12">
                    <div class="col-md-9 pr-1 pl-1 mb-2">
                        ...
                        <select name="item_id" id="item_id" class="form-control select2">
                            <option value="">-</option>
                            @foreach ($materiales as $index => $value)
