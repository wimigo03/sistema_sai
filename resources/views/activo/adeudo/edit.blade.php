    ...
    <div class="row ">
        <div class="col-md-12">
            ...
            <div class="body-border ">
                <form method="POST" action="{{ route('activo.adeudo.update', $adeudo->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row font-verdana-sm">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mr-4" id="nombres">{{ $adeudo->empleado->full_name }}</div>
                        </div>
                        <div class="col-md-4">
                            <label class="font-label">Cargo:</label>
                            <div id="cargo">{{ $adeudo->empleado->file->nombrecargo }}</div>
                        </div>
                        <div class="col-md-4 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" name="fecha_inicio" class="form-control"
                                    value="{{ old('fecha_inicio',$adeudo->fecha_inicio) }}">
                            </div>
                            @error('fecha_inicio')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" name="fecha_fin" class="form-control" value="{{ old('fecha_fin',$adeudo->fecha_fin) }}">
                            </div>
                            @error('fecha_fin')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="nro_contrato" class="form-control"
                                    value="{{ old('nro_contrato', $adeudo->nro_contrato) }}">
                            </div>
                            @error('nro_contrato')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" min="0" id="cantidad_activos" readonly name="cantidad_activos"
                                    class="form-control" value="{{ old('cantidad_activos', $adeudo->cantidad_activos) }}">
                            </div>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select name="motivo_retiro" class="form-control">
                                    @php
                                        $oldMotivoRetiro = old('motivo_retiro', $adeudo->motivo_retiro);
                                    @endphp

                                    @foreach (['CONCLUSION DE CONTRATO', 'MEMORANDUM DE AGRADECIMIENTO', 'SOLICITUD PARTICULAR'] as $option)
                                        <option value="{{ $option }}" @if (trim($oldMotivoRetiro) == trim($option)) selected @endif>
                                          {{ $option }}
                                        </option>
                                    @endforeach
                                </select>
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.response && res.response.ci) {
                        ...
                        $('#cantidad_activos').val(res.response.actuals.length);
                    } else {
