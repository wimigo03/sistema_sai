                ...
                <table class="table-bordered yajra-datatable hoverTable" style="width:100%;">
                    <thead class="font-courier">
                        <tr>
                            ...
                            <td class="text-center p-1 font-weight-bold"><b>GESTIONES</b></td>
                            <td class="text-center p-1 font-weight-bold"><b>OFICINA</b></td>
                            <td class="text-center p-1 font-weight-bold"><b>SIGLA</b></td>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.yajra-datatable').DataTable({
                ...
                serverSide: true,
                autoWidth: false,
                ajax: "{{ route('activo.organismo.list') }}",
                columns: [
