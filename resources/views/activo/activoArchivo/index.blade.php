...
@section('content')
    ...
    <div class="row font-verdana-bg mb-3 flex justify-content-between align-items-center">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#table-imagenes').DataTable({
                ...
                serverSide: true,
                autoWidth: false,
                ajax: "{{ route('activo.archivo.listado', $id) }}",
                columns: [{
                        data: 'DT_RowIndex',
                        orderable: false,
                        searchable: false,
            ...
            $('#btn_store_imagen').on('click', function(e) {
                ...
                $.ajax({
                    url: "{{ route('activo.archivo.store') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $('#btn_update_imagen').on('click', function(e) {
                ...
                $.ajax({
                    url: "/Activo/update/" + imagenId + "/archivo",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
