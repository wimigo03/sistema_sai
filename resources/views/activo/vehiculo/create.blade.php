    ...
    <div class="row ">
        <div class="col-md-12">
            ...
            <div class="body-border ">
                <form method="POST" action="{{ route('activo.vehiculo.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row font-verdana-sm">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="municipio_radicatoria" class="form-control"
                                    value="{{ old('municipio_radicatoria') }}">
                            </div>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select name="gnv" class="form-control @error('gnv') is-invalid @enderror">
                                    <option value="1" {{ old('gnv') == '1' ? 'selected' : '' }}>Verdadero</option>
                                    <option value="0" {{ old('gnv') == '0' ? 'selected' : '' }}>Falso</option>
                                </select>
                            </div>
                            @error('gnv')
                                <span class="invalid-feedback d-block" role="alert">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="nro_poliza_procedencia" class="form-control"
                                    value="{{ old('nro_poliza_procedencia') }}">
                            </div>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="b_sisa" class="form-control" value="{{ old('b_sisa') }}">
                            </div>
                            @error('b_sisa')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" name="vencimiento_poliza_seguro" class="form-control"
                                    value="{{ old('vencimiento_poliza_seguro') }}">
                            </div>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="canton" class="form-control" value="{{ old('canton') }}">
                            </div>
                            @error('canton')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
