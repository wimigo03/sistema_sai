                        ...
                        <table class="table-bordered yajra-datatable hoverTable" style="width:100%;">
                            <thead class="font-courier">
                                <tr>
                                    ...
                                    <td class="text-center p-1 font-weight-bold"><b>NOMBRE ARCHIVO</b></td>
                                    <td class="text-center p-1 font-weight-bold"><b>RUTA</b></td>
...
$(function() {
    ...
    var table = $('.yajra-datatable').DataTable({
        ...
        serverSide: true,
        autoWidth: false,
        ajax: "{{ route('activo.archivoadjunto.list') }}",
        columns: [

            {data: 'DT_RowIndex',orderable: false,searchable: false,class:'text-justify p-1 font-verdana'},

            {
                data: 'nombrearchivo', name: 'nombrearchivo',class:'text-justify p-1 font-verdana' },
            {
                data: 'ruta', name: 'ruta',class:'text-justify p-1 font-verdana'},
