    ...
    <div class="col-md-8">
        ...
        <div class="body-border">
            <font size="2" face="Courier New" >
                <form method="POST" action="{{ route('activo.archivoadjunto.store') }}">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" required name="nombrearchivo" class="form-control" placeholder="nombre del archivo..."
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" required name="ruta" class="form-control" placeholder="ruta..."
                                onkeyup="javascript:this.value=this.value.toUpperCase();">
                        </div>
                    </div>    
