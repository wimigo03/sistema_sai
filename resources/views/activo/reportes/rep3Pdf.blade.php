...
<head>
    ...
    <title>INVENTARIO ORDENADO POR GRUPO Y AUXILIAR CONTABLE</title>
        ...
        @foreach ($activosPorPagina as $index => $productosPagina)
            <header>
                @include('activo.reportes._header', [
                    'title' => 'INVENTARIO ORDENADO POR GRUPO Y AUXILIAR CONTABLE',
                ])
                <table class="table-data">
                    <tr>
                        <td width="40%">
                            ...
                            <h5>AUXILIAR CONTABLE: {{ $auxiliar->nomaux }}</h5>
                        </td>
                        <td class="text-top">
