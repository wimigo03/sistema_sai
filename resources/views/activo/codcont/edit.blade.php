    ...
    <div class="col-md-8">
        ...
        <div class="body-border">
            <font size="2" face="Courier New" >
                    <form method="POST" action="{{ route('activo.codcont.update', $codcont->idcodcont) }}">
                        @csrf
                        @method('POST')
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <input type="hidden" name="codcont" value="{{$codcont->codcont}}" readonly="true" class="form-control" required>

                                    <span class="input-group-text">{{$codcont->codcont}}</span>
                                </div>
                                <input type="text" name="nombre" value="{{$codcont->nombre}}" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" required name="vidautil" class="form-control" value="{{intval($codcont->vidautil)}}" required> 
                            </div>
                        </div>
                    </div>
