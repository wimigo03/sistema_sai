...
<div class="row font-verdana-12">
    ...
    <div class="col-md-4 text-right">
            ...
            <a href="{{route('activo.cargo.create')}}" class="tts:left tts-slideIn tts-custom" aria-label="Agregar">
                        ...
                        <table class="table-bordered yajra-datatable hoverTable" style="width:100%;">
                            <thead class="font-courier">
                                <tr>
                                    ...
                                    <td class="text-center p-1 font-weight-bold"><b>NOMBRE CARGO</b></td>
    ...
    var table = $('.yajra-datatable').DataTable({
        ...
        columns: [
...

            {
                ...
                data: 'nombrecargo', name: 'nombrecargo',class:'text-justify p-1 font-verdana'},
