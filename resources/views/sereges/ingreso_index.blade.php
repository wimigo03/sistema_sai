        ...
        <div class="col-md-10">
            ...
            <div class="row font-verdana-12">
                <div class="col-md-12">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <b>REGISTRO INGRESO</b>{{ $idregistro }}
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <select onchange="window.location.href=this.options[this.selectedIndex].value;">
                        <option value="#">seleccione una opcion</option>
                        <option value="{{ route('sereges.foto_index', $idregistro) }}">Historial Fotografico</option>
                        <option value="{{ route('sereges.albergue_index') }}">Registros de Ingreso</option>
                    ...
                    <span class="tts:left tts-slideIn tts-custom" aria-label="Agregar Nuevo Registro">
                        <a href="#createIngreso" data-toggle="modal">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" WIDTH="10">
                                                <span class="tts:left tts-slideIn tts-custom" aria-label="Ver Archivo">
                                                    <a href="../documentos/{{ $fotos->ruta }}" target="blank_"><i
