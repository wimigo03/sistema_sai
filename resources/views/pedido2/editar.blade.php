...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
        <div class="card-header bg-gradient-secondary text-white rounded d-flex flex-row-reverse" style="color:black;font-weight: bold;font-size: 16px;"><font >EDITAR SOLICITUD</font></div>
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                ...
                <form method="POST" action="{{ route('pedido.update', $compras->idcompra) }}">
                    ...
                    <div class="form-group row">
                        <label for="justificacion"
                            class="required col-md-4 col-form-label text-md-right">{{ __('Justificacion') }}</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="tipo"
                            class="required col-md-4 col-form-label text-md-right">{{ __('Tipo') }}</label>
                        <div class="col-md-2">
                    ...
                    <div class="form-group row">
                        <label for="controlinterno"
                            class="required col-md-4 col-form-label text-md-right">{{ __('Cont.Interno') }}</label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="controlinterno" placeholder=""
                                value="{{$compras->controlinterno}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label
                            class="required col-md-4 col-form-label text-md-right">{{ __('Cat.Programatica') }}</label>
