    ...
    <div class="col-md-8">
        ...
        <div class="row font-verdana-bg">
            ...
            <font size="2" face="Courier New" >
                <form method="POST" id="form" action="{{ route('medidacomb.update', $productos->idmedida) }}">
                    @csrf
                    @method('POST')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="nombremedida" id="nombremedida" class="form-control"
                               placeholder="Nombre..."
                               onkeyup="convertirAMayusculas(this)" value="{{$productos->nombremedida}}">
                        </div>
                    </div>
