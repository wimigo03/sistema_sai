    ...
    <form method="post" action="{{ route('combustibles.pedido.update') }}" id="form">
        ...
        <div class="form-group row">
            <div class="col-md-6">
                ...
                <textarea disabled  name="objeto" cols="1" rows="3" class="form-control form-control-sm font-verdana-bg" id="objeto" onkeyup="javascript:this.value=this.value.toUpperCase();">{{$compras->objeto}}</textarea>
            </div>
            <div class="col-md-6">
                <label for="justificacion" class="d-inline font-verdana-bg">
                    <b>Justificacion</b>&nbsp;<span style="font-size:10px; color: red;">*</span>
                </label>
                <textarea disabled  name="justificacion" cols="1" rows="3" class="form-control form-control-sm font-verdana-bg" id="justificacion" onkeyup="javascript:this.value=this.value.toUpperCase();">{{$compras->justificacion}}</textarea>
            </div>
            <div class="col-md-2">
                <label for="preventivo" class="d-inline font-verdana-bg">
                    <b>Preventivo</b>&nbsp;<span style="font-size:10px; color: red;">*</span>
                </label>
                <input type="text" disabled name="preventivo" id="preventivo" onchange="myFunction()" value="{{$compras->preventivo}}" class="form-control form-control-sm font-verdana-bg" id="preventivo">
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
                ...
                <input type="text" disabled  name="numcompra" id="numcompra" onchange="myFunctiondos()" value="{{$compras->numcompra}}" class="form-control form-control-sm font-verdana-bg" id="numcompra" onkeypress="return valideNumber(event);">
            </div>
            <div class="col-md-2">
                <label for="controlinterno" class="d-inline font-verdana-bg">
                    <b>Control Interno</b>&nbsp;<span style="font-size:10px; color: red;">*</span>
                </label>
                <input type="text" disabled ="controlinterno" value="{{$compras->controlinterno}}" class="form-control form-control-sm font-verdana-bg" id="controlinterno" onkeypress="return valideNumber(event);">
            </div>
            <div class="col-md-7">
