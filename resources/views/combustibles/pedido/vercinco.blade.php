...
<div class="row font-verdana-bg">
    ...
    <div class="col-md-8 text-right titulo">
        <b>FORMULARIO DE SOLICITUD EN  </b><b style='color:red'>ALMACEN</b> estado 5
    </div>
    <div class="col-md-12">
        <hr class="hrr">
    </div>
    ...
    <div class="col-md-5 text-right titulo">
        <b>Fecha Ingreso:</b>  <b style='color:red'>{{$Fechayhoratres}}</b>
    </div> 
</div>
    ...
    <form method="post" action="{{ route('pedidocomb.update') }}" id="form">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-2">
                ...
                <input type="text" name="tipo" value="{{$compras->tipo}}" class="form-control form-control-sm font-verdana-bg" id="tipo" onkeyup="convertirAMayusculas(this)">
