    ...
    <div class="col-md-8">
        ...
        <div class="body-border">
            <font size="2" face="Courier New" >
                    <form method="POST" action="{{ route('proveedor.update', $proveedores->idproveedor) }}">
                        @csrf
                        @method('POST')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input type="text" value="{{$proveedores->validezciproveedor}}" name="Ciexpiracion" value="" placeholder="dd/mm/aaaa" class="form-control form-control-sm font-verdana-bg" id="fechainicio" data-language="es" autocomplete="off">
                            </div>
                        </div>
