            ...
            <font size="2" face="Courier New" >
                <form method="POST" action="{{ route('proveedor.store') }}" id="form">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="Ciexpiracion" id="Ciexpiracion" value="" placeholder="dd/mm/aaaa" class="form-control form-control-sm font-verdana-bg" id="fechainicio" data-language="es" autocomplete="off">
                        </div>
                    </div>
