...
@section('content')
    ...
    <div class="row font-verdana-bg">
        ...
        <div class="col-md-10 text-right">
            ...
            @if ($estado == 0)
                <b style="color:rgb(11, 170, 34);font-weight: bold;"> No hay registros del detalle</b>
          
            @else
                {{-- <p style="color:red;font-weight: bold;">
                    sss No hay registros del detalle</p> --}}
            @endif
        </div>
    ...
    <div class="body-border" style="background-color: #FFFFFF;">
        <form action="{{ route('detalleparcial.store') }}" method="post" id="form">
            @csrf
            <br>
