        ...
        <div class="col-md-8">
            ...
            <div class="body-border">
                <font size="2" face="Courier New">
                    <form method="POST" action="{{ route('correspondencia2.updatepdf') }}" enctype="multipart/form-data"
                        id="form">
                        @csrf
                        <input type="hidden" value="{{ $idrecepcion }}" required name="idrecepcion" id="idrecepcion">
                        <br><br>
...
@section('scripts')
    <script>
        ...
        $("#cancelar").click(function() {
            ...
            $(".btn").hide();
            $(".spinner-btn-send").show();
            window.location.href = "{{ route('correspondencia2.gestionar', $idrecepcion) }}";
