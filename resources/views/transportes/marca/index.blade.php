...
<div class="row font-verdana-bg">
    <div class="col-md-8 titulo">
        <b>MARCA DE  MOVIILIDAD </b><b style='color:red'>UNIDAD TRANSPORTE</b>
    </div>
    <div class="col-md-4 text-right">
      
       
            <a href="{{route('marca.create')}}" class="tts:left tts-slideIn tts-custom" aria-label="Agregar">
...
$(function() {
    ...
    var table = $('.yajra-datatable').DataTable({
        ...
        serverSide: true,
        autoWidth: false,
        ajax: "{{ route('marca.list') }}",
        columns: [
            {data: 'DT_RowIndex',orderable: false,searchable: false,class:'text-justify p-1 font-verdana'},
  
            {
                data: 'nombremarca',name: 'nombremarca',class:'text-justify p-1 font-verdana'},
                {
                data: 'estadomarca',name: 'estadomarca',class:'text-justify p-1 font-verdana'},
