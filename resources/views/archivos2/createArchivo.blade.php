    ...
    <div class="col-md-10">
        ...
        <div class="body-border">
            <font size="2" face="Courier New" >
                    <form method="POST" action="{{ route('archivos2.insertar') }}"
                        ...
                        <div class="form-group row">
                            <label for="documento" style="color:black;font-weight: bold;"
                                class=" required col-md-4 col-form-label text-md-right"><b style="color: red">El tamaño del archivo no debe superar los 10 mb. Archivos(solo.pdf):</b></label>
