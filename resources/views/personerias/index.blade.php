...
@endif
    <div class="row font-verdana-12">
        ...
        <div class="col-md-6 text-right">
            ...
            <a href="{{ route('personerias.index2') }}" class="tts:left tts-slideIn tts-custom" aria-label="Personerias Antiguas">
                <button class="btn btn-default btn-flat pull-left" type="button">P.J.Antiguas
                    <i class="fa fa-files" style="font-size:14px"></i>&nbsp;
                </button>
            </a>

            <a href="{{ route('personerias.index3') }}" class="tts:left tts-slideIn tts-custom" aria-label="Personerias Actualizadas">
                <button class="btn btn-default btn-flat pull-left" type="button">P.J.Actualizadas
