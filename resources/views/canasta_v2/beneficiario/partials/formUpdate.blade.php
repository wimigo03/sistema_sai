<form action="{{ route('beneficiarios.update') }}" method="post" id="form" enctype="multipart/form-data">
    ...
    <input type="hidden" name="idBeneficiario" id="idBeneficiario" value="{{ $beneficiario->id }}"
        class="form-control form-control-sm font-verdana input-sm">

    <div class="form-group row font-verdana mb-2">
        <div class="col-md-2 pr-1">
            <label for="nombres" class="d-inline"><b>Nombres</b></label>
            <input type="text" name="nombres" id="nombres" value="{{ $beneficiario->nombres }}"
                class="form-control form-control-sm font-verdana input-sm"
                onchange="javascript:this.value=this.value.toUpperCase();">
        </div>
        <div class="col-md-2 pr-1 pl-1">
            <label for="ap" class="d-inline"><b>Ap.Paterno</b></label>
            <input type="text" name="ap" id="ap" value="{{ $beneficiario->ap }}"
                class="form-control form-control-sm font-verdana input-sm"
                onchange="javascript:this.value=this.value.toUpperCase();">
        </div>
        <div class="col-md-2 pr-1 pl-1">
            <label for="am" class="d-inline"><b>Ap.Materno</b></label>
            <input type="text" name="am" id="am" value="{{ $beneficiario->am }}"
                class="form-control form-control-sm font-verdana input-sm"
                onchange="javascript:this.value=this.value.toUpperCase();">
        </div>
        <div class="col-md-2 pr-1 pl-1">
            <label for="fnac" class="d-inline"><b>F.Nacimiento</b></label>
            <input type="date" name="fnac" id="fnac" value="{{ $beneficiario->fechaNac }}"
                class="form-control form-control-sm font-verdana input-sm">
        </div>
    ...
    <div class="form-group row font-verdana mb-2">
        <div class="col-md-2 pr-1">
            ...
            <input type="text" name="ci" id="ci" value="{{ $beneficiario->ci }}"
                class="form-control form-control-sm font-verdana input-sm">
        </div>
        <div class="col-md-2 pl-1">
        ...
        <div class="col-md-4 pr-1">
            ...
            <input type="text" name="direccion" id="direccion" value="{{ $beneficiario->direccion }}"
                class="form-control form-control-sm font-verdana input-sm"
                onchange="javascript:this.value=this.value.toUpperCase();">
        </div>
        ...
        <div class="col-md-2 pr-1">
            ...
            <select name="estado" id="estado" class="form-control form-control-sm select2">
                <option value="">-</option>
                <option value="A" @if ($beneficiario->estado == 'A') selected @endif>Activo</option>
        ...
        <div class="col-md-4 pr-1">
            ...
            <select name="barrio" id="barrio" class=" form-control select2">
                @foreach ($barrios as $barrio)
                    ...
                    <option value="{{ $barrio->id }}" @if ($beneficiario->idBarrio == $barrio->id) selected @endif>
        ...
        <div class="col-md-3 pr-1 pl-1">
            ...
            <select name="ocupacion" id="ocupacion" class=" form-control select2">
                @foreach ($ocupaciones as $ocupacion)
                    <option value="">-</option>
                    <option value="{{ $ocupacion->id }}" @if ($beneficiario->idOcupacion == $ocupacion->id) selected @endif>
                        {{ $ocupacion->ocupacion }}</option>
                @endforeach
            </select>
        </div>
        <div class="col-md-2 pr-1 pl-1">
            <label for="fregistro" class="d-inline"><b>F.Registro</b></label>
            <input type="text" name="fregistro" id="fregistro" disabled value="{{ $beneficiario->created_att }}"
                class="form-control form-control-sm font-verdana input-sm">
        </div>
    ...
    <div class="form-group row font-verdana mb-2">
        <div class="col-md-4">
            ...
            <textarea cols="1" rows="7" name="observacion" id="observacion"
                class="form-control form-control-sm font-verdana input-sm"
        ...
        <div class="col-md-5">
            ...
            <input type="file" name="documento" id="file" class="form-control form-control-sm font-verdana input-sm">
        </div>
