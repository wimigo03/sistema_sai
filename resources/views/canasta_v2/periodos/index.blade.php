    ...
    <div class="card-body body">
        <div class="form-group row font-roboto-12 abs-center">
            <div class="col-md-12 pr-1 pl-1">
                <a href="{{ route('paquetes.index') }}" class="btn btn-outline-primary font-roboto-12">
                    <i class="fa-solid fa-angles-left fa-fw"></i> Ir atras
                </a>
                <i class="fa fa-spinner fa-spin fa-lg fa-fw spinner-btn" style="display: none;"></i>
            </div>
        </div>
        <form action="{{ route('periodos.store') }}" method="post" id="form">
            @csrf
            ...
            <div class="form-group row font-roboto-12 abs-center">
                ...
                <div class="col-md-3 pr-1 pl-1 text-right">
                    ...
                    <a href="{{ route('periodos.finalizar',$id_paquete) }}" class="btn btn-success font-roboto-12">
                           ...
                           <tr class="font-roboto-11">
                               ...
                               <td class="text-center p-1">
                                   <span class="tts:left tts-slideIn tts-custom" aria-label="Eliminar">
                                       <a href="{{ route('periodos.eliminar',$paquetesPeriodo->id) }}" onclick="return confirm('Se va a eliminar el Item...')" class="badge-with-padding badge badge-danger">
