        ...
        <table class="table display table-striped table-bordered responsive hover-orange sortable" style="width:100%;">
            <thead>
                <tr class="font-roboto-11">
                    <th class="text-justify p-1">DISTRITO</th>
                    <th class="text-justify p-1">BARRIO</th>
            ...
            <tbody>
                @foreach ($entregas as $datos)
                    <tr class="font-roboto-11">
                        <td class="text-justify p-1" style="vertical-align: middle;">{{ $datos->_distrito }}</td>
                        <td class="text-justify p-1" style="vertical-align: middle;">{{ $datos->_barrio }}</td>
                        ...
                        <td class="text-center p-1" style="vertical-align: middle;">{{ $datos->ci . ' ' . $datos->expedido }}</td>
