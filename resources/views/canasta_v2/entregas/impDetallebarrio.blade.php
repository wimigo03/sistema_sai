        ...
        <table width="900" align="center" HEIGHT="410" class="tabla1 fondo_tabla">
            ...
            @foreach ($entregas as $entrega)
                ...
                <tr >
                    ...
                    <td style=" border-bottom: 1px solid #ccc;"><img src="{{ asset(substr($entrega->beneficiario->dirFoto , 3)) }}" align="center" height="30" with="30" /></td>
                    <td style=" border-bottom: 1px solid #ccc;">{{ $entrega->beneficiario->ci }}</td>
                    <td style=" border-bottom: 1px solid #ccc;">{{ $entrega->beneficiario->nombres }}</td>
                    <td style=" border-bottom: 1px solid #ccc;">{{ $entrega->beneficiario->ap }}</td>
                    <td style=" border-bottom: 1px solid #ccc;">{{ $entrega->beneficiario->am }}</td>
                    <td style=" border-bottom: 1px solid #ccc;">{{ $entrega->beneficiario->fechaNac }}</td>
                </tr>
            @endforeach
