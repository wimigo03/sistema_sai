                    ...
                    <tr class="font-verdana">
                        ...
                        <td class="text-center p-1">
                            ...
                            <span class="tts:left tts-slideIn tts-custom" aria-label="Actualizar Registro">
                                <a href="#edit{{ $datos->id }}" data-toggle="modal"
                                    class="btn btn-sm edit btn-flat"><i class='fa fa-edit' style="color: orange"></i></a>
                            </span>
                            ...
                            @if (App\Models\Canasta\Barrio::ESTADOS[$datos->estado] == 'HABILITADO')
                                <span class="tts:left tts-slideIn tts-custom" aria-label="Dehabilitar"
                                    ...
                                    <a href="{{ route('barrios.deshabilitar', $datos->id) }}"
                                        ...
                                        <i class="fa-regular fa-lg fa-down"></i>
                                    </a>
                                </span>
                            @else
                                <span class="tts:left tts-slideIn tts-custom" aria-label="Habilitar"
                                    ...
                                    <a href="{{ route('barrios.habilitar', $datos->id) }}"
                                        ...
                                        <i class="fa-regular fa-lg fa-up"></i>
                                    </a>
                                </span>
                            @endif
                        </td>
