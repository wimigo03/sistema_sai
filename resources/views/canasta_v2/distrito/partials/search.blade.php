<form action="#" method="get" id="form">
    <div class="form-group row">
        ...
        <div class="col-md-3 pr-1 pl-1">
            <input type="text" name="usuario" placeholder="--Usuario--" value="{{request('usuario')}}" class="form-control form-control-sm font-verdana-bg">
        </div>
        <div class="col-md-2 pr-1 pl-1">
            <select name="dea" id="dea" class="form-control form-control-sm">
                <option value="">-</option>
