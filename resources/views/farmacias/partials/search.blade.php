<form action="#" method="get" id="form">
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-2">
        ...
        <div class="col mb-2">
            <button class="btn btn-danger w-100 w-md-auto py-2 btn-size mr-2 font-roboto-14" type="button" onclick="limpiar();">
...
<div class="row">
    <div class="col-12 d-flex flex-column flex-md-row gap-2 justify-content-center justify-content-md-end">
        @can('farmacias.index')
            <button class="btn btn-outline-dark w-100 w-md-auto py-2 btn-size mr-2 font-roboto-14" type="button" onclick="turnos();">
                <i class="fas fa-calendar-alt fa-fw"></i> Turnos
            </button>
