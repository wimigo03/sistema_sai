...
<div class="form-group row">
    ...
    <div class="col-md-2">
        <input type="text" name="fecha_desde" value="" placeholder="--Desde--" value="{{request('fecha_desde')}}" class="form-control form-control-sm font-verdana-12" id="fecha_desde" data-language="es" autocomplete="off">
    </div>
    <div class="col-md-2">
        <input type="text" name="fecha_hasta" value="" placeholder="--Hasta--" value="{{request('fecha_hasta')}}" class="form-control form-control-sm font-verdana-12" id="fecha_hasta" data-language="es" autocomplete="off">
    </div>
</div>
<div class="form-group row">
