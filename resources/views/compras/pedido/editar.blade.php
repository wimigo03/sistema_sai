    ...
    <form method="post" action="{{ route('compras.pedido.update') }}" id="form">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-2">
                ...
                <input type="text" name="preventivo" value="{{$compras->preventivo}}" class="form-control form-control-sm font-verdana-bg" id="preventivo">
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
                ...
                <input type="text" name="numcompra" value="{{$compras->numcompra}}" class="form-control form-control-sm font-verdana-bg" id="numcompra" onkeypress="return valideNumber(event);">
            </div>
            <div class="col-md-2">
