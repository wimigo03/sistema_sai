    ...
    <script type="text/javascript">
        ...
        function totalSuma() {
            ...
            $("#detalle_tabla tbody tr").each(function() {
                ...
                if (typeof input_total === 'undefined' || input_total === null) {
                    input_total = '0';
                }
                input_total = input_total.replace(/,/g, '');
                input_total = isNaN(parseFloat(input_total)) ? 0 : parseFloat(input_total);
                total += input_total;
            });

            var cleaveInstance = new Cleave('#input-total-final', {
                numeral: true,
                numeralThousandsGroupStyle: 'thousand'
            });
            ...
            if(productos.length>0){
                for(var i=0;i<productos.length;i++){
                    ...
                    if(producto_id === '' || producto_id === '0'){
                        Modal("<b>[ERROR. ]</b> EXISTE UN PRECIO VACIO U IGUAL A 0");
                        return false;
                    }
                }
            }
