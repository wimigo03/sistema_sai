    ...
    <form action="#" method="post" id="form">
        ...
        <div class="form-group row font-roboto-13">
            ...
            <div class="col-md-2 pr-1 pl-1">
                ...
                <input type="text" name="c_interno" value="{{ $orden_compra->c_interno }}" id="c_interno" class="form-control font-roboto-12" oninput="this.value = this.value.toUpperCase();">
            </div>
            <div class="col-md-2 pr-1 pl-1">
                <label for="nro_preventivo" class="d-inline"><b>N° Preventivo</b></label>
                <input type="text" name="nro_preventivo" value="{{ $orden_compra->nro_preventivo }}" id="nro_preventivo" class="form-control font-roboto-12" oninput="this.value = this.value.toUpperCase();">
            </div>
        </div>
