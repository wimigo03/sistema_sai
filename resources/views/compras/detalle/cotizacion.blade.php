...
<div id="muestra" style="width: 900px;margin: auto;">
    ...
    <div>
        ...
        <p>
            En cumplimiento al memorándum de designación {{$ordencompra->memorandum1}} y el artículo 38 inciso e) del D.S.
        </p>
        <p>
        ...
        <table border="1" cellspacing="0" cellpadding="0" width="100%" style="font-size: 12px; border: 1px solid black;border-collapse: collapse;">
            <tbody>
                <tr>
                ...
                <tr style="font-size: 12px;">
                    ...
                    <td width="367" colspan="2" valign="top">
                        <p>
                            <strong>V</strong>
                            <strong>
                                ERIFICACIÓN DE DOCUMENTOS CUMPLE/NO CUMPLE
                            </strong>
                        </p>
                    </td>
                </tr>
