    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="569" colspan="5" >
                <p>
                    &nbsp;PROGRAMA REGIONAL DE SERVICIO DE GESTIÓN SOCIAL- YACUIBA&nbsp;
                    <p>
                    </p>
                </p>
            </td>
        ...
        <tr>
            ...
            <td width="569" colspan="5" >
                <p>
                    &nbsp; UNIDAD REGIONAL DE SERVICIO DE GESTIÓN SOCIAL
                    SEREGES-YACUIBA &nbsp;
                    <p>
                    </p>
                </p>
        ...
        <tr>
            ...
            <td width="569" colspan="5" >
                <p>
                    &nbsp; CARMEN YESSICA MENDIVIL RIBERA
                    <p>
                    </p>
                </p>
            </td>
            ...
            <td colspan="10" width="707" style="font-size: 12px;">
                ...
                <table border="1"  cellspacing="0" cellpadding="0" width="100%" style=" border: 1px solid black;border-collapse: collapse;">
                    <thead>
                        ...
                        <th style="font-size: 10px;" class="text-center p-1">U.MEDIDA</th>
