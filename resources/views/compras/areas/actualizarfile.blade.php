        ...
        <div class="card-header bg-gradient-secondary text-white rounded d-flex flex-row-reverse"><font size="3" ><strong>EDITAR REGISTRO</strong></font></div>
            ...
            <font size="2" face="Courier New" >
                <form method="POST" action="{{ route('file.update') }}">
                    ...
                    <div class="form-group row">
                        <label for="categoria" style="color:black;font-weight: bold;"
                    ...
                    <div class="form-group row">
                        <label for="niveladm" style="color:black;font-weight: bold;"
                    ...
                    <div class="form-group row">
                        <label for="clase" style="color:black;font-weight: bold;"
                    ...
                    <div class="form-group row">
                        <label for="nivelsal" style="color:black;font-weight: bold;"
                    ...
                    <div class="form-group row">
                        <label class="required  col-md-4 col-form-label text-md-right"
                            style="color:black;font-weight: bold;">{{ __('Area') }}</label>
