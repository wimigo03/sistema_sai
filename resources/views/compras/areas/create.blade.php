            ...
            <form method="POST" action="{{ route('areas.store') }}">
                ...
                <div class="form-group row font-verdana-12">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="nombre" class="form-control form-control-sm font-verdana-12" onchange="javascript:this.value=this.value.toUpperCase();" required>
                    </div>
                    <div class="col-md-8">
                        <label for="idnivel" class="d-inline">
                            <b>Nivel</b>
                        </label><br>
                        <select name="idnivel" id="permissions" class="form-control form-control-sm font-verdana-12 select2" required>
