...
<div class="row justify-content-center">
    <div class="col-md-10">
        <div class="card">
        <div class="card-header bg-gradient-secondary text-white rounded d-flex flex-row-reverse"><font size="3" ><strong>AGREGAR REGISTRO</strong></font></div>
            <div class="row">
            ...
            <font size="2" face="Courier New" >
                <form method="POST" action="{{ route('areas.guardarfile') }}">
                    ...
                    <div class="form-group row">
                        <label for="numfile" style="color:black;font-weight: bold;"
                    ...
                    <div class="form-group row">
                        <label for="cargo" style="color:black;font-weight: bold;"
                    ...
                    <div class="form-group row">
                        <label for="nombrecargo" style="color:black;font-weight: bold;"
                    ...
                    <div class="form-group row">
                        <label for="habbasico" style="color:black;font-weight: bold;"
                    ...
                    <div class="form-group row">
                        <label for="categoria"  style="color:black;font-weight: bold;" class="required col-md-4 col-form-label text-md-right">{{ __('Categoria') }}</label>
                        <div class="col-md-4">
                    ...
                    <div class="form-group row">
                        <label for="niveladm"  style="color:black;font-weight: bold;" class="required col-md-4 col-form-label text-md-right">{{ __('Nivel Admin.') }}</label>
                        <div class="col-md-4">
                    ...
                    <div class="form-group row">
                        <label for="clase"  style="color:black;font-weight: bold;" class="required col-md-4 col-form-label text-md-right">{{ __('Clase') }}</label>
                        <div class="col-md-4">
                    ...
                    <div class="form-group row">
                        <label for="nivelsal"  style="color:black;font-weight: bold;" class="required col-md-4 col-form-label text-md-right">{{ __('Nivel Salar.') }}</label>
                        <div class="col-md-4">
