<div class="card-body body">
    <form action="#" method="post" id="form">
        ...
        <input type="hidden" name="dea_id" value="{{ $solicitud_compra->dea_id }}" id="dea_id">
        <input type="hidden" name="area_id" value="{{ $solicitud_compra->idarea }}">
        <input type="hidden" name="user_id" value="{{ $solicitud_compra->user_id }}">
            ...
            <div class="col-md-2 pr-1 pl-1">
                ...
                <select name="tipo" id="tipo" class="form-control select2">
                    @foreach ($tipos as $index => $value)
                        <option value="{{ $index }}" @if($solicitud_compra->tipo == $index) selected @endif >{{ $value }}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-md-2 pr-1 pl-1">
