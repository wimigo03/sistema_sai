    ...
    <div class="col-md-8">
        ...
        <div class="body-border">
            <font size="2" face="Courier New" >
                <form method="POST" action="{{ route('compras.pedidoparcial.UpdateResponsable') }}">
                    @csrf
                    <input type="text" hidden name="idenc"  value="{{$responsable->idenc}}" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            ...
                            value="{{$responsable->abrev}}" >
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="nombre" class="required col-md-4 col-form-label text-md-right"
                            style="color:black;font-weight: bold;">Responsable:</label>
                        ...
                        <select name="idempleado" id="idempleado" placeholder="--Seleccionar--" class="form-control form-control-sm select2">
                            ...
                            @if ($value->idemp == $responsable->idemp)
                            <option value="{{ $value->idemp }}" selected>{{ $value->nombres}} {{ $value->ap_pat}} {{ $value->ap_mat}}</option>
