<form action="#" method="post" id="form">
    ...
    <div class="form-group row font-verdana-bg">
        ...
        <div class="col-md-2 pr-1">
            <label for="controlinterno" class="d-inline">Control Interno</label>
            <input type="text" name="controlinterno" value="{{ old('controlinterno') }}" id="controlinterno" class="form-control form-control-sm font-verdana intro" onkeypress="return valideNumber(event);">
        </div>
    ...
    <div class="form-group row font-verdana-bg">
        <div class="col-md-6 pr-1">
            <label for="idprograma" class="d-inline">Programa</label>
        ...
        <div class="col-md-6 pl-1">
            <label for="idcatprogramatica" class="d-inline">Cat. Programatica</label>
    ...
    <div class="form-group row font-verdana-bg">
        <div class="col-md-12">
            <label for="objeto" class="d-inline">Objeto</label>
    ...
    <div class="form-group row font-verdana-bg">
        <div class="col-md-12">
            <label for="justificacion" class="d-inline">Justificacion</label>
