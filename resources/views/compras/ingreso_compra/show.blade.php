                ...
                <form action="#" method="post" id="form">
                    ...
                    <div class="form-group row font-roboto-12">
                        ...
                        <div class="col-md-12 pr-1 pl-1 mb-2">
                            ...
                            <textarea name="obs" id="obs" class="form-control font-roboto-11" oninput="this.value = this.value.toUpperCase();" @if($ingreso_compra->estado != '1') disabled @endif>{{ $ingreso_compra->obs }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row font-roboto-12">
