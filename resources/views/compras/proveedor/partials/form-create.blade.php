    ...
    <form action="#" method="post" id="form">
        ...
        <div class="form-group row font-roboto-12">
            ...
            <div class="col-md-2 pr-1 pl-1">
                ...
                <input type="text" name="nro_carnet" value="{{ old('nro_carnet') }}" id="nro_ci" class="form-control font-roboto-12">
            </div>
        </div>
        <div class="form-group row font-roboto-12">
            <div class="col-md-4 pr-1 pl-1">
                <label for="representante" class="d-inline"><b>Representante</b></label>
                <input type="text" name="representante" value="{{ old('representante') }}" class="form-control font-roboto-12" oninput="this.value = this.value.toUpperCase();">
            </div>
