...
@section('content')
    ...
    <body>
        ...
        <div class="container col-md-6 table-responsive">
            ...
            <h4 style="text-align:center"><b style="color:rgb(16, 124, 33)">Calendario - Eventos</b></h4>
                    ...
                    @foreach ($weekdata['datos'] as $dayweek)
                        @if ($dayweek['mes'] == $mes)
                            <div class="col box-day  table-responsive"  style="font-size: 10px;color: rgb(26, 194, 11);text-align: center;font-weight: bold;">
                                ...
                                <span >
                                    <a href="{{ asset('/Evento/details/') }}/{{$dayweek['dia']}},{{$mespanish}},{{$data['year']}}">
                                ...
                                <!-- <a href="{{ asset('/Evento/details/') }}/{{$dayweek['dia']}},{{$mespanish}},{{$data['year']}}"><FONT size="1">Ver</FONT></a>-->
                                <p>
