        ...
        <div class="col-md-10">
            ...
            <div class="body-border">
                <font size="2" face="Courier New">
                    <form action="{{ asset('/Evento2/actualizar2/') }}/{{ $evento->id }}" method="post" id="form">
                        @csrf
                        <input type="date" class="form-control" name="fecha2" value="{{ $evento->fecha}}" hidden>
                        <input type="text" class="form-control" hidden name="usuario" value="{{$evento->usuario}}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" disabled name="usuario2" value="{{$evento->usuario}}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="date" class="form-control col-md-4" name="fecha" value="{{$evento->fecha}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <input type="time" name="hora"  class="form-control form-control-sm font-verdana-12" id="hora" value="{{$evento->horaini}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <textarea type="text" name="titulo" class="form-control " placeholder="Evento..."  id="titulo"
                                     cols="50" rows="3" onchange="javascript:this.value=this.value.toUpperCase();">{{$evento->titulo}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <textarea type="text" name="descripcion" class="form-control " placeholder="Detalles..."  id="descripcion"
                                     cols="50" rows="5" onchange="javascript:this.value=this.value.toUpperCase();">{{$evento->descripcion}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <textarea type="text" name="lugar" class="form-control " placeholder="Lugar..."  id="lugar"
                                     cols="50" rows="2" onchange="javascript:this.value=this.value.toUpperCase();">{{$evento->lugar}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <textarea type="text" name="coordinar" class="form-control " placeholder="Coordinar con..."  id="coordinar"
                                     cols="50" rows="2 onchange="javascript:this.value=this.value.toUpperCase();"">{{$evento->coordinar}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <textarea type="text" name="representante" class="form-control " placeholder="Representante G.A.R.G.CH..."  id="representante"
                                     cols="50" rows="2" onchange="javascript:this.value=this.value.toUpperCase();">{{$evento->representante}}</textarea>
                            </div>
                        </div>
