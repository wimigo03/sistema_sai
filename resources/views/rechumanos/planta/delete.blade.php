...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card font-verdana-bg">

            <div class="card-body font-verdana-bg">
            <div class="form-group row font-verdana-bg">
             ...
             <hr class="hrr">
                <form method="POST" action="{{ route('planta.delete') }}">
                    ...
                    <div class="form-group row font-verdana-bg">
                        <div class="col-md-2">
                            <label for="nombres"><b style="color:red;font-weight: bold;">F.Baja:</b></label>
                            <input required type="date" class="form-control" name="fechainactivo">
                        </div>
                        <div class="col-md-2">
                            <label for="nombres"><b style="color:red;font-weight: bold;">Motivo(s)</b></label>
                            <input required type="text" name="motivo" class="form-control " onchange="javascript:this.value=this.value.toUpperCase();"></input>
                        </div>
