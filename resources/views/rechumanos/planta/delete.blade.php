    ...
    <div class="col-md-10">
        ...
        <div class="card-header bg-gradient-secondary text-white rounded d-flex flex-row-reverse" style="color:black;font-weight: bold;font-size: 16px;"><font >{{$areaactual->nombrearea}}</font></div>
            ...
            <font size="2" face="Courier New" >
                <form method="POST" action="{{ route('planta.delete') }}">
                    @csrf
                    @method('POST')
                    ...
                    <span class="input-group col-md-1" style="color:red;font-weight: bold;">F.Baja:</span>
                        <div class="col-md-2 ">
                            <input required type="date" class="form-control" name="fechainactivo"
                               >
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <span class="input-group col-md-1" style="color:#0186C2;font-weight: bold;">F.Ingreso:</span>
                        <div class="col-md-2 ">
                    ...
                    <div class="form-group row">
                        <span class="input-group col-md-1 " style="color:#0186C2;font-weight: bold;">Exp.Sipp:</span>
                        <div class="col-md-2">
                    ...
                    <div class="form-group row">
                        <span class="input-group col-md-1 " style="color:#0186C2;font-weight: bold;">Exp.P.Vac:</span>
                    ...
                    <div class="form-group row">
                        ...
                        <span class="input-group col-md-1 " style="color:#0186C2;font-weight: bold;">Vac.Usadas:</span>
                    ...
                    <div class="form-group row">
                        ...
                        <span class="input-group col-md-1 " style="color:#0186C2;font-weight: bold;">Biometrico:</span>
                    ...
                    <div class="form-group row">
                        ...
                        <span class="input-group col-md-1 " style="color:#0186C2;font-weight: bold;">Reg.Prof:</span>
