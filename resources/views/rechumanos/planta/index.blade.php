    ...
    <script>
      ...
      var table = $('#customers-table').DataTable({
        ...
        columns: [
          ...
          {data: 'idarea', name: 'idarea', class:'text-center p-1 font-verdana-sm'},
          {data: 'nombrearea', name: 'nombrearea', class:'text-justify p-1 font-verdana-sm'},
          {data: 'btn2', name: 'btn2', orderable: true, searchable: false, class:'text-center p-1 font-verdana-sm'}
        ],
        order: [[1, 'asc']],
        "iDisplayLength": 15,
        "language":{
      ...
      function initTable(tableId, data) {
        $('#' + tableId).DataTable({
          ...
          columns: [
            { data: 'nombres', name: 'nombres', class:'text-justify p-1 font-verdana-sm'},
            { data: 'ap_pat', name: 'ap_pat', class:'text-justify p-1 font-verdana-sm'},
            { data: 'ap_mat', name: 'ap_mat', class:'text-justify p-1 font-verdana-sm'},
            { data: 'ci', name: 'ci', class:'text-justify p-1 font-verdana-sm'},
            { data: 'fechingreso', name: 'fechingreso', class:'text-justify p-1 font-verdana-sm'}          
          ],
            order: [[1, 'asc']],
            "language":{
              "info": "<span class='font-verdana'>Mostrando _START_ al _END_ de _TOTAL_</span>",
