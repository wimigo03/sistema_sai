<form action="#" method="post" id="form">
    ...
    <div class="form-group row font-roboto-12">
        <div class="col-md-3 pr-1 pl-1">
            ...
            <input type="text" name="titulo" value="{{ old('titulo') }}" class="form-control font-roboto-12 intro">
        </div>
        <div class="col-md-3 pr-1 pl-1">
            <label for="codigo" class="d-inline"><b>Codigo</b></label>
            <input type="text" name="codigo" value="{{ old('codigo') }}" class="form-control font-roboto-12 intro">
        </div>
    </div>
    <div class="form-group row font-roboto-12">
