<form action="#" method="post" id="form">
    ...
    <div class="form-group row font-roboto-12">
        <div class="col-md-3 pr-1 pl-1">
            ...
            <input type="text" value="{{ $user->dea->descripcion }}" class="form-control font-roboto-12 intro" disabled>
        </div>
        <div class="col-md-6 pr-1 pl-1 font-roboto-12">
            <label for="area" class="d-inline"><b>Area</b></label>
            <input type="text" value="{{ $user->area->nombrearea }}" class="form-control font-roboto-12 intro" disabled>
        </div>
        <div class="col-md-3 pr-1 pl-1 font-roboto-12">
            <label for="empleado" class="d-inline"><b>Empleado</b></label>
            <input type="text" value="{{ $user->usuariosEmpleados->nombres . ' ' . $user->usuariosEmpleados->ap_pat . ' ' . $user->usuariosEmpleados->ap_mat }}" class="form-control font-roboto-12 intro" disabled>
        </div>
    </div>
    <div class="form-group row font-roboto-12">
        <div class="col-md-3 pr-1 pl-1">
            <label for="name" class="d-inline"><b>Nombre de usuario</b></label>
            <input type="text" name="name" value="{{ $user->name }}" class="form-control font-roboto-12 intro">
        </div>
        <div class="col-md-3 pr-1 pl-1">
            <label for="email" class="d-inline"><b>E-Mail</b></label>
            <input type="text" name="email" value="{{ $user->email }}" class="form-control font-roboto-12 intro">
        </div>
        <div class="col-md-3 pr-1 pl-1">
