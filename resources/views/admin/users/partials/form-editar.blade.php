<form action="#" method="post" id="form">
    ...
    <div class="form-group row font-verdana-12">
        ...
        <div class="col-md-5 pl-1">
            ...
            <input type="text" name="name" value="{{ $user->name }}" class="form-control form-control-sm font-verdana-12 intro">
        </div>
    </div>
    <div class="form-group row font-verdana-12">
        <div class="col-md-3 pr-1">
            <label for="email" class="d-inline">E-Mail</label>
            <input type="text" name="email" value="{{ $user->email }}" class="form-control form-control-sm font-verdana-12 intro">
        </div>
        <div class="col-md-3 pr-1 pl-1">
            <label for="password" class="d-inline">Password</label>
            <input type="password" name="password" value="" class="form-control form-control-sm font-verdana-12 intro" required autocomplete="new-password">
        </div>
        <div class="col-md-3 pr-1 pl-1">
