<form action="#" method="get" id="form">
    <div class="form-group row">
        <div class="col-md-3 pr-1">
            <input type="text" name="nombre" value="{{request('nombre')}}" placeholder="--Nombres--" class="form-control font-verdana">
        </div>
        <div class="col-md-2 pr-1 pl-1">
            <input type="text" name="ap_pat" value="{{request('ap_pat')}}" placeholder="--Ap. Paterno--" class="form-control font-verdana">
        </div>
        <div class="col-md-2 pr-1 pl-1">
            <input type="text" name="ap_mat" value="{{request('ap_mat')}}" placeholder="--Ap. Materno--" class="form-control font-verdana">
        </div>
        <div class="col-md-2 pr-1 pl-1">
            <input type="text" name="username" value="{{request('username')}}" placeholder="--Usuario--" class="form-control font-verdana">
        </div>
        <div class="col-md-3 pl-1">
            <input type="text" name="email" value="{{request('email')}}" placeholder="--Email--" class="form-control font-verdana">
        </div>
    </div>
    <div class="form-group row">
