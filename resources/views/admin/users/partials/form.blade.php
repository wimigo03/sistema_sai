<form action="#" method="post" id="form">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6" id="permissions-select">
            <select name="roles[]" id="permissions" class="@error('permissions') is-invalid @enderror"  multiple>
    ...
    <div class="form-group row font-verdana-bg">
        ...
        <div class="col-md-5 pr-1">
            <label for="name" class="d-inline">Nombre(usuario)</label>
    ...
    <div class="form-group row font-verdana-bg">
        ...
        <div class="col-md-2 pl-1">
            <label for="password-confirm" class="d-inline">DEA</label>
            <select name="dea" id="dea" placeholder="--Seleccionar--" class="form-control form-control-sm select2">
                <option value="">-</option>
                <option value="1" >YACUIBA</option>
                <option value="2">VILLAMONTES</option>
                <option value="3">CARAPARI</option>
